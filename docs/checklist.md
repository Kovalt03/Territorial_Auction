...
| ⬜ | 경매 강제 시작·활성/비활성 | `POST /territories/{id}/start-auction`, `PATCH /auction-enabled` | Phase 2 |
| ⬜ | 영토 등급 변경 | `PATCH /territories/{id}/grade` | Phase 2 |
...
| — | 대륙 / 생산 랭킹 | — | BE 미구현이라 탭 제거 (추후 구현 시 재추가) |
